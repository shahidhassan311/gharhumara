        ...
        <ul class="x-navigation">
            ...
            <li class="xn-openable active">
                ...
                <ul>
                    ...
                    <li class="active"><a href="pages-address-book.html"><span class="fa fa-users"></span> Address Book</a>
                    </li>
