...
@section('content')
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Admin Purchase Details</li>
        </ul>
        <!-- END BREADCRUMB -->

        <!-- PAGE TITLE -->
        <div class="page-title">
            <a href="/user_purchase_request"><h2><span class="fa fa-arrow-circle-o-left"></span> Admin Purchase Details</h2></a>
        </div>
        <!-- END PAGE TITLE -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            @foreach ($purchase as $key => $item)
                                <form action="{{url('/user_sale_request_store',$item->purchase_id)}}" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
                                    <input type="hidden" name="_token" value="{{(csrf_token())}}" />

                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Tag:</label>
                                        <div class="col-md-6" style="padding-top: 6px;">
                                            <span >{{ $item->purchase_tag }}</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
