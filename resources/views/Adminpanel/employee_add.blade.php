...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <a href="/employee_details"><h2><span class="fa fa-arrow-circle-o-left"></span>Add Employee</h2></a>
        </div>
        <!-- END PAGE TITLE -->
        ...
        <div class="page-content-wrap">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="block">
                        <form action="{{url('/employee_store')}}" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
                            <input type="hidden" name="_token" value="{{(csrf_token())}}" />
                            <div class="form-group">
                                <label class="col-md-3 control-label">Refferal id:</label>
                                <div class="col-md-6">
                                    <input type="number" name="refferal_id" class="form-control">
