...
@section('content')
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="">Add Sale Property</a></li>
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Add Sale Property</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{url('/user_sales_req_store')}}" role="form" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Property Area (sq):</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="amount" placeholder="Enter Property Amount: e.g (1 crore , 1 lakh , 1 thousand...) " class=" form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="file" multiple class="file" name="image[]"
