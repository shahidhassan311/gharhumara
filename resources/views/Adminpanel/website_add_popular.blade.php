...
@section('content')
    ...
    <div class="page-content">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Add Popular Property</li>
        </ul>
        <!-- END BREADCRUMB -->

        <!-- PAGE TITLE -->
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Add Popular Property</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{url('/add_bahria_store')}}" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
                                <input type="hidden" name="_token" value="{{(csrf_token())}}" />
                                <input type="hidden" value="popular" name="type">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Tag:</label>
                                    <div class="col-md-6">
                                        <input type="text" name="tag"  placeholder="Enter Property Tag" class="form-control">
                                        @if ($errors->has('tag'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" name="no_of_bedrooms" placeholder="Enter Number of Bedrooms" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="amount" placeholder="Enter Property Amount"  class=" form-control">
