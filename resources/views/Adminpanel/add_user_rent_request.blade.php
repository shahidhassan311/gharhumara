...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span> Add Rent Property</h2>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{url('/user_rent_req_store')}}" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
                                <input type="hidden" name="_token" value="{{(csrf_token())}}" />
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Tag:</label>
                                    <div class="col-md-6">
                                        <select class="form-control select" name="rent_tag">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="rent_amount" placeholder="Enter Rent Amount"  class=" form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="advanced_amount" placeholder="Enter Advanced Amount"  class=" form-control">
