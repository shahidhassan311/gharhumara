                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="heading-title heading-title-alt">
                            <h3>Purchase Property Listings</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="property-container">
                                <div class="property-image">
                                    <a href="/purchase_info/{{ $item->purchase_id }}">
                                        @if($item->images == '')
                                            <img src="{{ URL::to('/') }}/uploads/default_img.png" style="height: 244px;" alt="">
                                        @else
                                ...
                                <div class="property-content">
                                    <h3><a href="">{{ $item->property_name }}</a> <small>{{ $item->address  }}</small></h3>
                                </div>
                            </div>
                        </div>
                    @endforeach
