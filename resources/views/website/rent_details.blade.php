                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="location">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        @foreach ($rent as $key => $item)
                                            <form method="post" action="{{url('/rent_property_message')}}">
                                                <input type="hidden" name="_token" value="{{(csrf_token())}}" />
                                                <input type="hidden" class="form-control input-lg" name="pro_id" value="{{ $item->rent_id }}">
                                                <input type="hidden" class="form-control input-lg" name="type" value="rent">
