...
<script type="text/javascript" src="{{ URL::to('/') }}/adminpanel/js/notification_ajax.js"></script>
<!-- END PLUGINS -->
<script type="text/javascript" src="{{ URL::to('/') }}/adminpanel/js/button.js"></script>
<script type="text/javascript" src="{{ URL::to('/') }}/adminpanel/js/append_input_contact.js"></script>
...
<script type='text/javascript' src='{{ URL::to('/') }}/adminpanel/js/plugins/validationengine/languages/jquery.validationEngine-en.js'></script>
<script type='text/javascript' src='{{ URL::to('/') }}/adminpanel/js/plugins/validationengine/jquery.validationEngine.js'></script>

<script type='text/javascript' src='{{ URL::to('/') }}/adminpanel/js/plugins/jquery-validation/jquery.validate.js'></script>

<script type='text/javascript' src='{{ URL::to('/') }}/adminpanel/js/plugins/maskedinput/jquery.maskedinput.min.js'></script>


<script type='text/javascript' src='{{ URL::to('/') }}/adminpanel/js/plugins/bootstrap/bootstrap-select.js'></script>
