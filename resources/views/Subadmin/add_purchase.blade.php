...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <a href="/purchase_data_sa"><h2><span class="fa fa-arrow-circle-o-left"></span>  Add Purchase</h2></a>
        </div>
        <!-- END PAGE TITLE -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{url('/subadmin_add_purchase_store')}}" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" >
